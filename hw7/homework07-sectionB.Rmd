...
The above plot shows the weight of 4 chicks which were heaviest in each diet group. This plot only shows the maximum of the weight variable for each diet group. This plot isn't the best to copare overall effect of diets on weight of chicks as it only compares the extreme values.
