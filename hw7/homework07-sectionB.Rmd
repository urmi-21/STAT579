...
The second plot average weight in each diet group over time. The mean is computed for all the chicks in a diet group. This plot is better to compare the effect of diets on the weights. We can actually see how the mean weight changes over time for each diet group.
