...
cap<-paste(strwrap("Plot showing total gross against WeekNo for the two selected movies. A Quiet Place started earning at 50 million whereas Super Troopers 2 started at 15 million. The trajectory over the weeks show that A Quiet Place earned much more than Super Troopers 2.",width = 95),collapse = "\n")
