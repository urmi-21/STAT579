...
I mapped the popularity to a popularity score on a scale of -2 to +2, where -2 is Very unfavorably, -1 is Somewhat unfavorably, 0 is neutral, +1 is Somewhat favorably and +2 is Very favorably. Overall popularity of a character is then the mean of all the scores by the respondents. R2-D2 is more popular than  C-3P0.
